...
<div class="exception-summary">
    <div class="container">
        <div class="exception-message-wrapper">
            <h1 class="break-long-words exception-message">{{ $exception->getMessage() ?? '' }}</h1>
            ...
            <tr>
                <th>
                    <h3 class="trace-class">
                        ...
                        <span class="exception_title"><span
                                title="{{get_class($exception)}}">{{get_class($exception)}}</span></span>
                    </h3>
            ...
            <tr>
                <td>
                    <span class="block trace-file-path">in <span
                            title="{{ $exception->getFile() ?? '' }}"><strong>{{ $exception->getFile() ?? '' }}</strong> line {{ $exception->getLine() ?? '' }}</span></span>
                </td>
            </tr>
                    ...
                    <td>
                        at <span class="trace-class"><span
                            ...
                            class="trace-arguments"></span>)<span class="block trace-file-path">in <span
                                title=""><strong>{{ $value['file'] ?? '' }}</strong> line {{ $value['line'] ?? '' }}</span></span>
                    </td>
                </tr>
            @endforeach
            </tbody>
...
<div class="container">
    <table>
        ...
        <tr>
            <td>
                <pre>{{ json_encode($context, JSON_THROW_ON_ERROR | JSON_PRETTY_PRINT) }}</pre>
            </td>
        </tr>
        </tbody>
    </table>
